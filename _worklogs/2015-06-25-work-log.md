...
* Fri, Mar 18, 2016
    * Working on a review for _Molecular Ecology Resources_
    * Finishing up some revisions on the Lower Granite paper to send to Mike Ackerman.
    

* Thu, Mar 17, 2016
    * Meeting with Ben Moran, the Holllings Scholar coming to work with me in the summer.
      He was here till noon.  We got his computer configured, talked about recommended 
      reading, and then we talked a bit about statistical models, etc.  I think it is going
      to be a good summer.
    * Working on a review for _Molecular Ecology Resources_
    * Wrestling with ggplot and rasters...

---

* Wed, Mar 16, 2016
    * Formulating some DAGs for the Bayesian-hierarchical Reporting Units project.  
      Cool stuff. Thomas suggested I see if STAN could be used for the MCMC on the 
      allele frequency prior.  I think that might be worth checking out.
    * Talked with Anthony and Thomas about Sr.Microhap.  Thomas has gotten some great results
      using Bio::CIGAR to extract the positions we are interested in!!
    * Went to the seminar on bioenergetics of Chinook salmon in the San Joaquin.

* Tuesday, Mar 15, 2016
    * An hour or two of help to Martha to get BibTeX running on her thesis.  She wanted
      references at the end of every chapter which is a job for the chapterbib package,
      but the ucthesis class file conflicted with that, so I had to hack ucthesis.  Looking
      like it works now.  
    * Lab meeting.  Vicky Pritchard presented.  
    * Set up a repository for dealing with all my work with Ben Moran, the Hollings Scholar.
      Started putting together a manuscript in CJFAS format.
    
* Monday, Mar 14, 2016
    * I presented at the Pacific Collegiate School's Math-Science Day.  I gave the same
      presentation 4 different times to four different groups of students.  I told them about
      the work that I do as a statistical geneticist, and specifically focused on examples of 
      detecting species hybrids from genetic data.  It was well-received.
    * Working on revisions for the lower granite paper.
    

* Sunday, Mar 13, 2016
    * Got the list of sturgeon to regenotype together for Ellen.

* Friday, Mar 11, 2016
    * Lab meeting
    * Sturgeon clean up
    * Skyped with Kristen and colleagues about combining isotopes and genetics and habitat
      suitability for assigning Wilson's Warblers.

* Thursday, Mar 10, 2016
    * Dealt with the unannounced matching pairs in the sturgeon data then heavily pruned the
      repository to have only the stuff we need.
    * Outreach, 1:30 - 2:30 at gateway --- helping students with science experiments involving 
      crayfish behavior.
...
* Monday, Mar 7, 2016
    * Worked with Anthony on rockfish species ID loci.
    * All hands meeting.
...
* Friday, Mar 4, 2016
    ...
    * Lab meeting.  Thierry presented after Martha.
